...
// node_modules/@spyglassmc/core/lib/common/Dev.js
var Dev;
(function(Dev2) {
  function assertDefined(value) {
    if (value === void 0) {
      throw new Error(`'${Dev2.stringify(value)}' is 'undefined'`);
    }
  }
  Dev2.assertDefined = assertDefined;
  function assertNever(value) {
    throw new Error(`'${Dev2.stringify(value)}' is not of type 'never'`);
  }
  Dev2.assertNever = assertNever;
  function assertTrue(value, message) {
    if (!value) {
      throw new Error(`Assertion failed: ${message}. '${Dev2.stringify(value)}' should be true.`);
    }
  }
  Dev2.assertTrue = assertTrue;
  function estimateMemoryUsage(value) {
    const ByteToBits = 8;
    const PointerSize = 8;
    let ans = 0;
    const calculatedObjects = /* @__PURE__ */ new Set();
    const stack = [value];
    while (stack.length) {
      ...
      switch (typeof current) {
        case "bigint": {
          ...
          ans += (2 + Math.ceil(bits / (ByteToBits * PointerSize))) * PointerSize;
          break;
        }
        case "boolean":
          ans += PointerSize;
  ...
  Dev2.estimateMemoryUsage = estimateMemoryUsage;
  ...
  Dev2.stringify = stringify;
})(Dev || (Dev = {}));

// node_modules/@spyglassmc/core/lib/common/Logger.js
var Logger;
(function(Logger2) {
  function create() {
    return console;
...
// node_modules/@spyglassmc/core/lib/common/Operations.js
...
function SingletonPromise(getKey = (args) => args[0]) {
  return (_target, _key, descripter) => {
    ...
    descripter.value = function(...args) {
      ...
      const ans = decoratedMethod.apply(this, args).then((ans2) => (promises.delete(key), ans2), (e) => (promises.delete(key), Promise.reject(e)));
...
var Singleton = (_target, _key, descripter) => {
  let value;
  const decoratedMethod = descripter.value;
  descripter.value = function(...args) {
...
(function(ResourceLocation2) {
  ResourceLocation2.TagPrefix = "#";
  ResourceLocation2.NamespacePathSep = ":";
  ResourceLocation2.PathSep = "/";
  ResourceLocation2.DefaultNamespace = "minecraft";
  function lengthen(value) {
    switch (value.indexOf(ResourceLocation2.NamespacePathSep)) {
      case -1:
        return `${ResourceLocation2.DefaultNamespace}${ResourceLocation2.NamespacePathSep}${value}`;
      case 0:
        return `${ResourceLocation2.DefaultNamespace}${value}`;
      default:
        return value;
    }
  }
  ResourceLocation2.lengthen = lengthen;
  function shorten(value) {
    return value.replace(/^(?:minecraft)?:/, "");
  }
  ResourceLocation2.shorten = shorten;
...
(function(Arrayable2) {
  ...
  Arrayable2.toArray = toArray;
})(Arrayable || (Arrayable = {}));
var TypePredicates;
(function(TypePredicates2) {
  function isString(value) {
    return typeof value === "string";
  }
  TypePredicates2.isString = isString;
...
async function parseGzippedJson(externals, buffer) {
...
function merge(a, b) {
  const ans = (0, import_rfdc.default)()(a);
...
var Lazy;
(function(Lazy2) {
  const LazyDiscriminator = /* @__PURE__ */ Symbol("LazyDiscriminator");
...
function getStates(category, ids, ctx) {
  ...
  for (const id of ids) {
    ctx.symbols.query(ctx.doc, category, id).forEachMember((state, stateQuery) => {
      ...
      const set = ans[state] ??= /* @__PURE__ */ new Set();
...
var binarySearch = import_binary_search.default;
...
function emplaceMap(map2, key, handler) {
  if (map2.has(key)) {
    ...
    const value = handler.insert(key, map2);
    map2.set(key, value);
    return value;
  } else {
...
function normalizeUriPathname(pathname) {
  return pathname.replace(/%3A/gi, ":").replace(/^\/[A-Z]:\//, (match) => match.toLowerCase());
}
...
// node_modules/@spyglassmc/core/lib/common/ReadonlyProxy.js
var ReadonlyProxy;
(function(ReadonlyProxy2) {
  function create(obj) {
    return new Proxy(obj, new ReadonlyProxyHandler());
  }
  ReadonlyProxy2.create = create;
})(ReadonlyProxy || (ReadonlyProxy = {}));
var ReadonlyProxyHandler = class {
...
// node_modules/@spyglassmc/core/lib/common/TwoWayMap.js
var TwoWayMap = class {
  _map = /* @__PURE__ */ new Map();
  _reversedMap = /* @__PURE__ */ new Map();
  constructor(values = []) {
...
// node_modules/@spyglassmc/core/lib/common/UriStore.js
var UriStore = class _UriStore {
  #trie = /* @__PURE__ */ new Map();
  /**
  ...
  add(uri) {
    ...
    for (const [i, part] of parts.entries()) {
      ...
      if (!node.has(part)) {
        node.set(part, shouldAddDir ? /* @__PURE__ */ new Map() : {});
      }
      if (!isLast) {
  ...
  has(uri) {
    ...
    return isDir ? node instanceof Map : !!node && typeof node === "object" && !(node instanceof Map);
  }
  /**
  ...
  *getSubFiles(uri) {
   ...
   */
  clone() {
    const clonedStore = new _UriStore();
  ...
  #dissectUri(uriString) {
    ...
    const parts = [
      uri.protocol,
      uri.host || "localhost",
      ...normalizeUriPathname(uri.pathname).split("/").filter((p) => p).map(decodeURIComponent)
    ];
    return [parts, isDir];
  }
  /**
...
// node_modules/@spyglassmc/core/lib/common/StateProxy.js
var BranchOff = /* @__PURE__ */ Symbol("StateBranchOff");
var Is = /* @__PURE__ */ Symbol("IsStateProxy");
var Origin = /* @__PURE__ */ Symbol("OriginState");
var Redo = /* @__PURE__ */ Symbol("RedoStateChanges");
var Undo = /* @__PURE__ */ Symbol("UndoStateChanges");
var StateProxy;
(function(StateProxy2) {
  function branchOff(proxy) {
    return proxy[BranchOff]();
  }
  StateProxy2.branchOff = branchOff;
  function create(obj) {
    if (StateProxy2.is(obj)) {
  ...
  StateProxy2.create = create;
  function dereference(value) {
    return StateProxy2.is(value) ? value[Origin] : value;
  }
  StateProxy2.dereference = dereference;
  function is(obj) {
    return obj?.[Is];
  }
  StateProxy2.is = is;
  ...
  StateProxy2.redoChanges = redoChanges;
  function undoChanges(proxy) {
    proxy[Undo]();
  }
  StateProxy2.undoChanges = undoChanges;
})(StateProxy || (StateProxy = {}));
var StateProxyHandler = class {
  rootOps;
  map = /* @__PURE__ */ new Map();
  constructor(rootOps) {
...
// node_modules/@spyglassmc/core/lib/service/fileUtil.js
var fileUtil;
(function(fileUtil2) {
  function getRelativeUriFromBase(target, base2) {
    const baseUri = new Uri(base2);
    ...
    if (baseComponents.length > targetComponents.length || baseComponents.some((bc, i) => decodeURIComponent(bc) !== decodeURIComponent(targetComponents[i]))) {
      return void 0;
    }
    return targetComponents.slice(baseComponents.length).map(encodeURIComponent).join("/");
  }
  fileUtil2.getRelativeUriFromBase = getRelativeUriFromBase;
  function isSubUriOf(uri, base2) {
    return getRelativeUriFromBase(uri, base2) !== void 0;
  }
  fileUtil2.isSubUriOf = isSubUriOf;
  ...
  fileUtil2.isFileUri = isFileUri;
  function extname(value) {
    const i = value.lastIndexOf(".");
    return i >= 0 ? value.slice(i) : void 0;
  }
  fileUtil2.extname = extname;
  function basename(uri) {
    const i = uri.lastIndexOf("/");
    return i >= 0 ? uri.slice(i + 1) : uri;
  }
  fileUtil2.basename = basename;
  function dirname(uri) {
    const i = uri.lastIndexOf("/");
    return i >= 0 ? uri.slice(0, i) : uri;
  }
  fileUtil2.dirname = dirname;
  function getParentOfUri(uri) {
    return new Uri(".", trimEndingSlash(uri.toString()));
  }
  fileUtil2.getParentOfUri = getParentOfUri;
  async function ensureDir(externals, path, mode = 511) {
    try {
  ...
  fileUtil2.ensureDir = ensureDir;
  async function ensureParentOfFile(externals, path, mode = 511) {
    return ensureDir(externals, getParentOfUri(path), mode);
  }
  fileUtil2.ensureParentOfFile = ensureParentOfFile;
  async function chmod(externals, path, mode) {
    return externals.fs.chmod(path, mode);
  }
  fileUtil2.chmod = chmod;
  async function ensureWritable(externals, path) {
    try {
      await chmod(externals, path, 438);
    } catch (e) {
  ...
  fileUtil2.ensureWritable = ensureWritable;
  async function getAllFiles(externals, root, depth = Number.POSITIVE_INFINITY) {
    async function walk(path, level) {
      ...
      return (await Promise.all(entries.map(async (e) => {
        const entryPath = fileUtil2.join(path.toString(), e.name);
        if (e.isDirectory()) {
...
//# sourceMappingURL=chunk-JP2CSJTY.js.map
